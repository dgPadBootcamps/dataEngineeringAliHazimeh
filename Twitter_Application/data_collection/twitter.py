...
class Tweet(base.Item):
    ...
    outlinksss = base._DeprecatedProperty('outlinksss', lambda self: ' '.join(self.outlinks) if self.outlinks else '',
                                          'outlinks')
    tcooutlinksss = base._DeprecatedProperty('tcooutlinksss',
        ...
        while True:
            ...
            for instruction in obj['timeline']['instructions']:
                ...
                for entry in entries:
                    ...
                    elif direction is ScrollDirection.BOTH and bottomCursorAndStop is None and (
    ...
    def get_items(self):
        ...
        if self._mode is TwitterTweetScraperMode.SINGLE:
            ...
            for obj in self._iter_api_data(f'https://twitter.com/i/api/2/timeline/conversation/{self._tweetId}.json',
                                           params, paginationParams, direction=ScrollDirection.BOTH):
